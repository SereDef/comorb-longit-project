...
def update_graph(dep_selection, cmr_selection, stationary):
    # Prevent update if the selection is not allowed (i.e., combination of markers not available)
    ...
    updated_graph = make_net_riclpm(dep_selection, cmr_selection, params)

    tab_df = make_table_riclpm(dep_selection, cmr_selection, params)
